...
public class GameController {
    ...
    private final GameServiceImpl playerGameService;

    @Autowired
    public GameController (GameServiceImpl playerGameService) {
        super();
    ...
    public ResponseEntity<PlayerDTO> addPlayer(@RequestBody PlayerDTO playerDTO) throws Exception {
        ...
        try {
            return new ResponseEntity<>(playerGameService.createPlayer(playerDTO), HttpStatus.CREATED);
    ...
    public ResponseEntity<PlayerDTO> updatePlayer(@Parameter(description = "La ID del jugador a editar")
        ...
        try {
            return new ResponseEntity<>(playerGameService.editPlayer(player_id, playerDTO), HttpStatus.OK);
     ...
     */
    @PostMapping(value = "/{_id}/game", produces = "application/json")
    ...
    public ResponseEntity<GameDTO> newGame(@Parameter(description = "La ID del jugador que llença els daus")
                                           @PathVariable("_id") String _id) throws Exception {

        return new ResponseEntity<>(playerGameService.createGame(String.valueOf(_id)), HttpStatus.CREATED);
    ...
    public ResponseEntity<Messages> deleteGames(@Parameter(description = "La ID del jugador a qui esborrar les jugades")
        ...
        try {
            playerGameService.removeGamesByPlayer(player_id);
    ...
    public ResponseEntity<List<PlayerDTO>> getAllPlayers() throws Exception {
        try {
            return new ResponseEntity<>(playerGameService.getPlayersWithWinRatio(), HttpStatus.OK);
    ...
    public ResponseEntity<List<GameDTO>> getAllGamesByPlayer(@Parameter(description = "La ID del jugador de qui veure les jugades")
                                                             @PathVariable String player_id, WebRequest request) throws Exception {
        try {
            return new ResponseEntity<>(playerGameService.getGamesListByPlayer(player_id), HttpStatus.OK);
        } catch (PlayerNotFoundException | GamesNotFoundException e) {
            throw e;
        } catch (Exception e) {
    ...
    public ResponseEntity<Messages> getWinAverage(WebRequest request) throws Exception {
        ...
        try {
            return new ResponseEntity<>(new Messages(HttpStatus.OK.value(), LocalDateTime.now(), playerGameService.getWinningAverage(), request.getDescription(false)), HttpStatus.OK);
        } catch (PlayerNotFoundException | GamesNotFoundException e) {
            throw e;
        } catch (Exception e) {
    ...
    public ResponseEntity<PlayerDTO> getLoser() throws Exception {
        ...
        try {
            return new ResponseEntity<>(playerGameService.getTopLoser(), HttpStatus.OK);
        } catch (PlayerNotFoundException | GamesNotFoundException e) {
            throw e;
        } catch (Exception e) {
    ...
    public ResponseEntity<PlayerDTO> getWinner() throws Exception {
        ...
        try {
            return new ResponseEntity<>(playerGameService.getTopWinner(), HttpStatus.OK);
        } catch (PlayerNotFoundException | GamesNotFoundException e) {
            throw e;
        } catch (Exception e) {
