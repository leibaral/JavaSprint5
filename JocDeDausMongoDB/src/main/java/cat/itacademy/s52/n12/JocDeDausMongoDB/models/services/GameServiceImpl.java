...
public class GameServiceImpl implements IGameService, IPlayerService{
    ...
    @Override
    @Transactional
    public void removeGamesByPlayer(String playerID) {
        List<Game> gamesToRemove = ifExistsGames(playerID);
        gamesToRemove.clear();
    }

    @Override
    public List<GameDTO> getGamesListByPlayer(String playerID) {
    ...
    public PlayerDTO editPlayer(String playerID, PlayerDTO playerDTO) {
        Player playerToUpdate = playerRepository.findByPlayerID(playerID);
        PlayerDTO playerValidated = validatePlayerName(playerDTO);
    ...
    public PlayerDTO validatePlayerName(PlayerDTO playerDTO) {
        if (playerDTO.getPlayerName()==null || playerDTO.getPlayerName().isEmpty()) {
            ...
            playerDTO.setPlayerID(String.valueOf(counter.getNextSequence("Player")));
            return playerDTO;
        }
     ...
     */
    public List<Game> ifExistsGames(String playerID) {
        Player playerById = playerRepository.findByPlayerID(playerID);
