package cat.itacademy.s52.n11.JocDeDausMySQL.controllers;
...
import cat.itacademy.s52.n11.JocDeDausMySQL.models.exceptions.Messages;
...
import cat.itacademy.s52.n11.JocDeDausMySQL.models.services.IGameService;
import cat.itacademy.s52.n11.JocDeDausMySQL.models.services.IPlayerService;
 ...
 */
    ...
    public ResponseEntity<PlayerDTO> updatePlayer(@Parameter(description = "La ID del jugador a editar")
                                                      @PathVariable Long player_id, @RequestBody PlayerDTO playerDTO) throws Exception {
 ...
 */
    ...
    public ResponseEntity<GameDTO> newGame(@Parameter(description = "La ID del jugador que llença els daus")
                                               @PathVariable Long player_id) throws Exception {
 ...
 */
    ...
    public ResponseEntity<Messages> deleteGames(@Parameter(description = "La ID del jugador a qui esborrar les jugades")
                                                   @PathVariable Long player_id, WebRequest request) throws Exception {
        try {
